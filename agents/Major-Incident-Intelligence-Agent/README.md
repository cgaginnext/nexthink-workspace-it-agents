...
Major Incident Intelligence Agent is a Nexthink Workspace IT Agent designed to support IT Operations, NOC, Infrastructure, Support teams.

It focuses on correlating weak operational signals to detect major incidents early and assess impact severity and blast radius.
...
`IT Operations` `NOC` `Infrastructure` `Support`
...
> This agent is specialized in major incident intelligence agent use cases. Please use Nexthink Assist or a dedicated agent for other topics.
