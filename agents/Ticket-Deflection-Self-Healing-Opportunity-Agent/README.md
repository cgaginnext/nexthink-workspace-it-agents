...
Ticket Deflection & Self-Healing Opportunity Agent is a Nexthink Workspace IT Agent designed to support Service Desk, Automation, Support, DEX teams.

It focuses on detecting repetitive incidents and identifies the best self-healing and automation opportunities.

The agent acts as an automation and remediation governance specialist. It helps operators turn Nexthink telemetry into clear investigation paths, prioritized findings, and practical next actions.

## Interested Teams

`Service Desk` `Automation` `Support` `DEX`
...
> This agent is specialized in ticket deflection & self-healing opportunity agent use cases. Please use Nexthink Assist or a dedicated agent for other topics.
