...
Live Dashboard Builder is a Nexthink Workspace IT Agent designed to support DEX, Operations, Leadership, Workplace Analytics teams.

It focuses on dynamically creating Nexthink dashboards and operational reporting views from natural language requests.

The agent acts as a workplace analytics and operational steering assistant. It helps operators turn Nexthink telemetry into clear investigation paths, prioritized findings, and practical next actions.

## Interested Teams

`DEX` `Operations` `Leadership` `Workplace Analytics`
...
> This agent is specialized in live dashboard builder use cases. Please use Nexthink Assist or a dedicated agent for other topics.
...
> Create an executive DEX dashboard highlighting the most impacted business units, top productivity degradation drivers, collaboration experience trends, operational hotspots, remediation effectiveness, automation impact, ticket deflection trends, and structural risk areas. Organize the dashboard using clear operational storytelling.
