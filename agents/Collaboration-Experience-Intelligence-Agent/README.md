...
Collaboration Experience Intelligence Agent is a Nexthink Workspace IT Agent designed to support Collaboration, Support, DEX, Workplace Engineering teams.

It focuses on monitoring collaboration quality across Teams, Zoom, Webex, peripherals, drivers, and networking conditions.
...
`Collaboration` `Support` `DEX` `Workplace Engineering`
...
> This agent is specialized in collaboration experience intelligence agent use cases. Please use Nexthink Assist or a dedicated agent for other topics.
