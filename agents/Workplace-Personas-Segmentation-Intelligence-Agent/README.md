...
Workplace Personas & Segmentation Intelligence Agent is a Nexthink Workspace IT Agent designed to support DEX, Workplace Analytics, Transformation, Digital Workplace teams.

It focuses on building workplace personas from employee behaviors and digital workstyles to enable intelligent personalization.
...
`DEX` `Workplace Analytics` `Transformation` `Digital Workplace`
...
> This agent is specialized in workplace personas & segmentation intelligence agent use cases. Please use Nexthink Assist or a dedicated agent for other topics.
