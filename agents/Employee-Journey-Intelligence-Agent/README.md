...
Employee Journey Intelligence Agent is a Nexthink Workspace IT Agent designed to support Transformation, Adoption, DEX, EUC teams.

It focuses on analyzing employee journeys such as onboarding, migrations, refresh cycles, and transformation initiatives.
...
`Transformation` `Adoption` `DEX` `EUC`
...
> This agent is specialized in employee journey intelligence agent use cases. Please use Nexthink Assist or a dedicated agent for other topics.
