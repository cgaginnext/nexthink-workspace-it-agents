...
VIP Experience Protection Agent is a Nexthink Workspace IT Agent designed to support Executive IT, DEX, Support, Digital Workplace teams.

It focuses on protecting executives and business-critical users by proactively identifying degradation risks before user impact escalates.
...
`Executive IT` `DEX` `Support` `Digital Workplace`
...
> This agent is specialized in vip experience protection agent use cases. Please use Nexthink Assist or a dedicated agent for other topics.
