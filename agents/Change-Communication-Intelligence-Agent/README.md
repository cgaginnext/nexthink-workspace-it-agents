...
Change Communication Intelligence Agent is a Nexthink Workspace IT Agent designed to support Change Management, Adoption, DEX, Communications teams.

It focuses on optimizing IT communication and Engage campaigns through behavioral analysis and adoption insights.

The agent acts as a change, deployment, and transformation readiness specialist. It helps operators turn Nexthink telemetry into clear investigation paths, prioritized findings, and practical next actions.

## Interested Teams

`Change Management` `Adoption` `DEX` `Communications`
...
> This agent is specialized in change communication intelligence agent use cases. Please use Nexthink Assist or a dedicated agent for other topics.
...
> Analyze the effectiveness of IT communications and Engage campaigns by identifying which messages, communication timing strategies, targeting methods, behavioral patterns, and engagement sequences generate the highest employee adoption, awareness, participation, and operational outcomes while minimizing communication fatigue.
