...
Workforce Sentiment Inference Agent is a Nexthink Workspace IT Agent designed to support DEX, HR IT, Digital Workplace, Support teams.

It focuses on detecting populations impacted by silent digital friction and operational fatigue patterns before support escalation.
...
`DEX` `HR IT` `Digital Workplace` `Support`
...
> This agent is specialized in workforce sentiment inference agent use cases. Please use Nexthink Assist or a dedicated agent for other topics.
