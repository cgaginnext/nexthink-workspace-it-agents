...
SaaS Experience Optimization Agent is a Nexthink Workspace IT Agent designed to support Collaboration, DEX, Cloud, Digital Workplace teams.

It focuses on analyzing employee experience across SaaS platforms such as Microsoft 365, Teams, SAP, and Salesforce.

The agent acts as a collaboration, SaaS, and cloud experience analyst. It helps operators turn Nexthink telemetry into clear investigation paths, prioritized findings, and practical next actions.

## Interested Teams

`Collaboration` `DEX` `Cloud` `Digital Workplace`
...
> This agent is specialized in saas experience optimization agent use cases. Please use Nexthink Assist or a dedicated agent for other topics.
...
- Application latency
- Crash and freeze patterns
- Call quality
- Network and proxy conditions
- Browser health
...
> Analyze Microsoft 365, Teams, SAP, Salesforce, and browser-based SaaS performance degradations across the organization. Correlate latency, crashes, freezes, browser instability, VPN conditions, endpoint performance, driver issues, Wi‑Fi quality, and geographic patterns to identify the factors generating the highest employee productivity loss.
