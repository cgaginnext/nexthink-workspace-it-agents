...
Employee Friction Intelligence Agent is a Nexthink Workspace IT Agent designed to support DEX, Digital Workplace, Support, EUC teams.

It focuses on detecting hidden day-to-day digital friction such as slowness, freezes, unstable Wi‑Fi, and repeated interruptions.
...
`DEX` `Digital Workplace` `Support` `EUC`
...
> This agent is specialized in employee friction intelligence agent use cases. Please use Nexthink Assist or a dedicated agent for other topics.
...
> Detect the most structurally frustrating employee experience degradations across the workplace estate by correlating freezes, crashes, login delays, unstable Wi‑Fi, VPN instability, poor collaboration quality, excessive CPU usage, endpoint instability, repeated interruptions, device slowness, and degraded application responsiveness.
