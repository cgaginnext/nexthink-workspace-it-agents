...
Shadow IT & AI Usage Intelligence Agent is a Nexthink Workspace IT Agent designed to support Security, Governance, Compliance, DEX teams.

It focuses on detecting unmanaged SaaS, AI platforms, extensions, and unsanctioned employee workflows.

The agent acts as a security, compliance, and endpoint governance specialist. It helps operators turn Nexthink telemetry into clear investigation paths, prioritized findings, and practical next actions.

## Interested Teams

`Security` `Governance` `Compliance` `DEX`
...
> This agent is specialized in shadow it & ai usage intelligence agent use cases. Please use Nexthink Assist or a dedicated agent for other topics.
...
> Detect unmanaged SaaS applications, AI tools, browser extensions, automation platforms, and unsanctioned employee workflows across the organization. Correlate usage patterns with business entities, browser activity, collaboration behaviors, and data exposure indicators to identify governance, compliance, and data leakage risks. Highlight emerging adoption patterns, risky populations, and shadow workflows likely to create operational or regulatory exposure.
