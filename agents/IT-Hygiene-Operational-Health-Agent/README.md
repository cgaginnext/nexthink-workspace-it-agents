...
IT Hygiene & Operational Health Agent is a Nexthink Workspace IT Agent designed to support IT Operations, Endpoint Engineering, EUC, Support teams.

It focuses on maintaining operational hygiene by detecting unhealthy collectors, degraded devices, and technical debt accumulation.
...
`IT Operations` `Endpoint Engineering` `EUC` `Support`
...
> This agent is specialized in it hygiene & operational health agent use cases. Please use Nexthink Assist or a dedicated agent for other topics.
